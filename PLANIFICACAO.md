...
|  4  | O programa deve sortear um número aleatório que não tenha mais que 4 números e que esteja entre 1 e 6.|
...
|  9  | O programa deve recusar se o palpite dado pelo utilizador não for igual ao número sorteado.|
